<?php
	...
	if(isset($_POST['imprimir'])){
	    ...
	    $pdf->SetTitle('Relatório de entregas: '.$from_title.' - '.$to_title);  
	    ...
	    $content = '';  
	    $content .= '
	      	<h2 align="center">Futsmash</h2>
	      	<h4 align="center">RELATÓRIO DE ENTREGAS</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Data</b></th>
	                <th width="30%" align="center"><b>Comprador</b></th>
					<th width="40%" align="center"><b>Transação</b></th>
					<th width="15%" align="center"><b>Quantidade</b></th>  
	           </tr>  
	      ';  
